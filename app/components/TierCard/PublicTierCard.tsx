...
export default function PublicTierCard({ item, isMobile }: Props) {
      ...
      <div className="flex items-center gap-5 max-lg:gap-1">
        ...
        >
          <div className="w-full pl-5 relative flex h-[200px] justify-between backdrop-blur-lg bg-[#FAF0E6] dark:bg-[#1A1625] max-md:h-[100px]">
            <div className="flex flex-col justify-center w-full p-5 overscroll-contain z-20 max-w-md">
              <h2
                className={`${josefin.className} text-4xl lg:overflow-ellipsis lg:whitespace-nowrap lg:overflow-hidden max-lg:text-2xl max-lg:absolute`}
              >
                {item.title}
              </h2>
